...
def fromASCII_links(payload):
    ...
    # কেস ২: ডেটা আছে
    if not num_bytes:
        # হেডার আছে কিন্তু ডেটা নেই (যেমন \x05), ত্রুটিপূর্ণ।
...
if compression_possible_msg:
    ...
    if compressed_payload_bytes_len > input_bytes_utf8_msg:
        ...
        # সফলভাবে কম্প্রেসড হয়েছে (কোনো প্রিফিক্স নেই)
...
if compression_possible_img:
    ...
    # [m> প্রিফিক্স সহ কম্প্রেসড পেলোড
...
if compression_possible_vid:
    ...
    # [v> প্রিফিক্স সহ কম্প্রেসড পেলোড
...
# 1. পেলোডকে মার্কার দিয়ে বিভক্ত করুন
...
part_img = finalPayload[idx_m:idx_v] # [m> মার্কার সহ
part_vid = finalPayload[idx_v:]      # [v> মার্কার সহ
...
# 3. ইমেজ লিঙ্ক পার্ট টেস্ট করুন
print("\n--- Testing Image Links ---")
data_img = part_img[3:] # [m> মার্কার বাদ দিন
recovered_simplified_img = ""
# ডেটা আছে কিনা এবং প্রথম বাইটটি হেডার (0-8) কিনা তা পরীক্ষা করুন
...
# 4. ভিডিও লিঙ্ক পার্ট টেস্ট করুন
print("\n--- Testing Video Links ---")
data_vid = part_vid[3:] # [v> মার্কার বাদ দিন
