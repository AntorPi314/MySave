...
for char in inputMessage:
    if char in model1_map:
        ...
        payLoad = f"[v>{inputMessage}".encode('utf-8')
...
if compression_possible:
    ...
    # Add the [v> prefix.
    payLoad = b"[v>" + compressed_payLoad
...
if compression_possible:
    ...
    if not payLoad.startswith(b'[v>'):
        print("Error: Payload missing [v> prefix.")
